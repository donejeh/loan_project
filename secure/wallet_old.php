...
';
                ...
                <form id="manage_widthdrwal">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control" name="bank_name" value="<?php echo isset($_SESSION['b_account_name']) ? $_SESSION['b_bank_name'] : '' ?>" readonly>

                        <input type="hidden" class="form-control" name="id" value="<?php echo $_SESSION['b_user_id']; ?>" readonly>
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control" name="account_name" value="<?php echo isset($_SESSION['b_account_name']) ? $_SESSION['b_account_name'] : '' ?>" readonly>
                    </div>
                
                    <div class="row">
                        <label for="">Account Number</label>
                        <input type="text" class="form-control" name="account_number" value="<?php echo isset($_SESSION['b_account_name']) ? $_SESSION['b_account_number'] : '' ?>" readonly>
                      </div>
