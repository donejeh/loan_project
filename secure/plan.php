				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="number" name="months" id="" class="form-control text-right" required>
							</div>
							<div class="form-group">
								<label class="control-label">Interest</label>
								<div class="input-group">
								  <input type="number" step="any" required min="0" max="100" class="form-control text-right" name="interest_percentage" aria-label="Interest">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-danger " type="button" onclick="_reset()"> Cancel</button>
							</div>
						</div>
					</div>
				</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_plan" type="button" data-id="<?php echo $row['id'] ?>" data-months="<?php echo $row['months'] ?>" data-penalty_rate="<?php echo $row['penalty_rate'] ?>" data-interest_percentage="<?php echo $row['interest_percentage'] ?>" >Edit</button>
